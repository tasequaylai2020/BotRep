...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://github.com/tasequaylai2020/BotRep')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/tasequaylai2020/BotRep'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/subin_works'),     
        ],
        [
